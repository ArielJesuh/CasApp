...
@Component({
  selector: 'app-gestionar-viviendas',
  templateUrl: './gestionar-viviendas.component.html',
  styleUrls: ['./gestionar-viviendas.component.css']
})
export class GestionarViviendasComponent implements OnInit{
  ...
  ngOnInit(): void {
    ...
    this.getListViviendas(this.id);
  }

  getListViviendas(id:any){
    this._viviendaService.getViviendaInmo(id).subscribe((data: any) => {
